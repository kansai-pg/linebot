...
session_write_close();
$sendurl = "https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=1656389284&redirect_uri=https://linebot.japan-is.fun/view.php&state=" . $_SESSION['state'] .  "&scope=profile";
